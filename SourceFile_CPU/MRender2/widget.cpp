...
void Widget::on_Xadd_clicked()
{
    scene.imagecube.dif_shift(0.1,0,0);
    show3D();
}
void Widget::on_Xred_clicked()
{
    scene.imagecube.dif_shift(-0.1,0,0);
    show3D();
}
void Widget::on_Yadd_clicked()
{
    scene.imagecube.dif_shift(0,0.1,0);
    show3D();
}
void Widget::on_Yred_clicked()
{
    scene.imagecube.dif_shift(0,-0.1,0);
    show3D();
}
void Widget::on_Zadd_clicked()
{
    scene.imagecube.dif_shift(0,0,0.1);
    show3D();
}
void Widget::on_Zred_clicked()
{
    scene.imagecube.dif_shift(0,0,-0.1);
    show3D();
}
